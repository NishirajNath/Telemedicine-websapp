...
var firebaseConfig = {
 ...
 let contactInfo = firebase.database().ref("infos/clinic/homesample");
  ...
  function submitForm(e) {
    ...
    console.log(name, email, phone_num, aDate, Address1, Address2, city, pin, message);
  
    saveContactInfo(name, email, phone_num, aDate, Address1, Address2, city, pin, message);
  ...
  function saveContactInfo(name, email, phone_num, aDate, Address1, Address2, city, pin, message) {
